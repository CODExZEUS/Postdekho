...
async def search(bot, message):
    ...
    if message.text.startswith("/"):
       return    
    query   = message.text 
    head    = "<u>Here is the results 👇\n\nPromoted By </u> <b><I>@Film_Nest</I></b>\n\n"
    results = ""
    try:
       ...
       if bool(results)==False:
          ...
          msg = await message.reply_photo(photo="https://telegra.ph/file/840993e53388a44855fd5.jpg",
